...
export const messagesEn = {
  ...
  leases: {
    ...
    detail: {
      ...
      inspectionColumns: { type: 'Type', date: 'Date', odometer: 'Odometer', condition: 'Condition', notes: 'Notes', branch: 'Branch', inspector: 'Inspector' },
      incidentColumns: { type: 'Type', date: 'Date', description: 'Description', cost: 'Est. Cost', claim: 'Claim #', resolved: 'Resolved' },
    },
  ...
  crudVehicles: {
    ...
    bulkUpload: {
      ...
      templateCols: 'plateNumber, plateLetters, plateTypeCode, vin, make, model, modelYear, color, fuelType, transmissionType, bodyType, seats, ownerBranchId, currentKm',
      uploading: 'Uploading…',
      result: {
        created: 'Created',
        skipped: 'Skipped',
...
export const messagesAr: Messages = {
  ...
  leases: {
    ...
    detail: {
      ...
      inspectionColumns: { type: 'النوع', date: 'التاريخ', odometer: 'العداد', condition: 'الحالة', notes: 'ملاحظات', branch: 'الفرع', inspector: 'المفتش' },
      incidentColumns: { type: 'النوع', date: 'التاريخ', description: 'الوصف', cost: 'التكلفة المقدرة', claim: 'رقم المطالبة', resolved: 'تم الحل' },
    },
